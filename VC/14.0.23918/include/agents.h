...
private:
    typedef typename ITarget<_Source_type>::filter_method _MyFilter_method;
...
protected:
    ...
    /// </param>
    /**/
    void register_filter(_MyFilter_method const& _Filter)
    {
        if (_Filter != NULL)
        {
            _M_pFilter = new _MyFilter_method(_Filter);
        }
    }
...
private:
    typedef typename source_block<_TargetLinkRegistry, _MessageProcessorType>::_Target_type _MyTarget_type;
    typedef typename ITarget<_Source_type>::filter_method _MyFilter_method;
...
protected:
    ...
    /// </summary>
    /**/
    virtual void process_input_messages(_Inout_ message<_MyTarget_type> * _PMessage)
    {
        throw invalid_operation("To use batched processing, you must override process_input_messages in the message block.");
    }
...
private:
    ...
    typedef typename source_block<_TargetLinkRegistry>::_Target_type _MyTarget_type;
    typedef typename source_block<_TargetLinkRegistry>::target_iterator _MyTarget_iterator;
    typedef typename ITarget<typename propagator_block<_TargetLinkRegistry, _SourceLinkRegistry>::_Source_type>::filter_method _MyFilter_method;
...
public:
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    unbounded_buffer(_MyFilter_method const& _Filter) :
      _M_fForceRepropagation(false)
    {
        this->initialize_source_and_target();
        this->enable_batched_processing();
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    unbounded_buffer(Scheduler& _PScheduler, _MyFilter_method const& _Filter) :
      _M_fForceRepropagation(false)
    {
        this->initialize_source_and_target(&_PScheduler);
        this->enable_batched_processing();
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    unbounded_buffer(ScheduleGroup& _PScheduleGroup, _MyFilter_method const& _Filter) :
      _M_fForceRepropagation(false)
    {
        this->initialize_source_and_target(NULL, &_PScheduleGroup);
        this->enable_batched_processing();
...
private:
    ...
    /// </param>
    /**/
    void _Propagate_priority_order(::Concurrency::details::_Queue<message<_MyTarget_type>> & _MessageBuffer)
    {
        message<_MyTarget_type> * _Msg = _MessageBuffer._Peek();
        ...
        while (_Msg != NULL)
        {
            ...
            for (_MyTarget_iterator _Iter = this->_M_connectedTargets.begin(); *_Iter != NULL; ++_Iter)
            {
                ITarget<_MyTarget_type> * _PTarget = *_Iter;
...
public:
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    overwrite_buffer(_MyFilter_method const& _Filter) :
        _M_fIsInitialized(false), _M_pMessage(NULL), _M_pReservedMessage(NULL)
    {
        this->initialize_source_and_target();
        this->register_filter(_Filter);
    ...
    /**/
    overwrite_buffer(Scheduler& _PScheduler,
        _MyFilter_method const& _Filter) :
        _M_fIsInitialized(false), _M_pMessage(NULL), _M_pReservedMessage(NULL)
    {
        this->initialize_source_and_target(&_PScheduler);
        this->register_filter(_Filter);
...
private:
    typedef multi_link_registry<ISource<_Type>> _SourceLinkRegistry;
    typedef typename ITarget<typename target_block<_SourceLinkRegistry>::_Source_type>::filter_method _MyFilter_method;
...
public:
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    single_assignment(_MyFilter_method const& _Filter) :
        _M_fIsInitialized(false), _M_pMessage(NULL)
    {
        this->initialize_source_and_target();
        this->register_filter(_Filter);
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    single_assignment(Scheduler& _PScheduler, _MyFilter_method const& _Filter) :
        _M_fIsInitialized(false), _M_pMessage(NULL)
    {
        this->initialize_source_and_target(&_PScheduler);
        this->register_filter(_Filter);
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    single_assignment(ScheduleGroup& _PScheduleGroup, _MyFilter_method const& _Filter) :
        _M_fIsInitialized(false), _M_pMessage(NULL)
    {
        this->initialize_source_and_target(NULL, &_PScheduleGroup);
        this->register_filter(_Filter);
...
private:
    ...
    typedef typename source_block<_TargetLinkRegistry>::target_iterator _MyTarget_iterator;
    typedef typename ITarget<typename propagator_block<_TargetLinkRegistry, _SourceLinkRegistry>::_Source_type>::filter_method _MyFilter_method;
    typedef typename propagator_block<_TargetLinkRegistry, _SourceLinkRegistry>::source_iterator _MySource_iterator;
...
public:
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    join(size_t _NumInputs, _MyFilter_method const& _Filter)
        : _M_messageArray(_NumInputs),
          _M_savedMessageIdArray(_NumInputs)
    {
        _Initialize(_NumInputs);
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    join(Scheduler& _PScheduler, size_t _NumInputs, _MyFilter_method const& _Filter)
        : _M_messageArray(_NumInputs),
          _M_savedMessageIdArray(_NumInputs)
    {
        _Initialize(_NumInputs, &_PScheduler);
    ...
    /// <seealso cref="ScheduleGroup Class"/>
    /**/
    join(ScheduleGroup& _PScheduleGroup, size_t _NumInputs, _MyFilter_method const& _Filter)
        : _M_messageArray(_NumInputs),
          _M_savedMessageIdArray(_NumInputs)
    {
        _Initialize(_NumInputs, NULL, &_PScheduleGroup);
...
protected:
    ...
    message_status propagate_message(_Inout_ message<_Type> * _PMessage, _Inout_ ISource<_Type> * _PSource)
    {
        ...
        size_t _Slot = 0;
        bool _Found = false;
        for (_MySource_iterator _Iter = this->_M_connectedSources.begin(); *_Iter != NULL; ++_Iter)
        {
            if (*_Iter == _PSource)
            {
                _Found = true;
        ...
        if (fIsGreedy)
        {
            ...
            for (size_t i = 0; i < _M_messageArray._M_count; i++)
            {
                for(;;)
                {
                    ...
                    if (_Saved_id != -1)
                    {
                        _MySource_iterator _Iter = this->_M_connectedSources.begin();
...
public:
    ...
    /// </param>
    /**/
    _Reserving_node(ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_fIsInitialized(false),
        _M_savedId(-1),
        _M_pReservedSource(NULL)
    {
    ...
    /// </param>
    /**/
    _Reserving_node(Scheduler& _PScheduler, ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_fIsInitialized(false),
        _M_savedId(-1),
        _M_pReservedSource(NULL)
    {
    ...
    /// </param>
    /**/
    _Reserving_node(ScheduleGroup& _PScheduleGroup, ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_fIsInitialized(false),
        _M_savedId(-1),
        _M_pReservedSource(NULL)
    {
...
public:
    ...
    /// </param>
    /**/
    _Greedy_node(ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_savedId(-1),
        _M_pGreedyMessage(NULL)
    {
        register_filter(_Filter);
    ...
    /// </param>
    /**/
    _Greedy_node(Scheduler& _PScheduler, ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_savedId(-1),
        _M_pGreedyMessage(NULL)
    {
        register_filter(_Filter);
    ...
    /// </param>
    /**/
    _Greedy_node(ScheduleGroup& _PScheduleGroup, ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_savedId(-1),
        _M_pGreedyMessage(NULL)
    {
        register_filter(_Filter);
...
public:
    ...
    /// </param>
    /**/
    _Non_greedy_node(ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_savedId(-1),
        _M_reservedId(-1),
        _M_pReservedSource(NULL)
    {
    ...
    /// </param>
    /**/
    _Non_greedy_node(Scheduler& _PScheduler, ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_savedId(-1),
        _M_reservedId(-1),
        _M_pReservedSource(NULL)
    {
    ...
    /// </param>
    /**/
    _Non_greedy_node(ScheduleGroup& _PScheduleGroup, ISource<_Type> * _PSource, size_t _Index, ITarget<size_t> * _PTarget, _MyFilter_method const& _Filter) :
        _M_savedId(-1),
        _M_reservedId(-1),
        _M_pReservedSource(NULL)
    {
