...
struct Has_GetSinkMapFinder : ATLImplementationDetails::false_type {};

template<class T>
struct Has_GetSinkMapFinder<T, ATLImplementationDetails::void_t<typename T::_GetSinkMapFinder>> : ATLImplementationDetails::true_type {};
