...
private:
	...
	{
		return U::_GetBindEntries(ATLImplementationDetails::forward<Args>(args)...);
	}

	template<class... Args>
	decltype(auto) call_OutputColumnsClass_GetBindEntries(ATLImplementationDetails::low_priority_tag, Args&&... args) const
	{
		return ::ATL::_OutputColumnsClass::_GetBindEntries(ATLImplementationDetails::forward<Args>(args)...);
	}
	...
	{
		return U::_GetParamEntries(ATLImplementationDetails::forward<Args>(args)...);
	}

	template<class... Args>
	decltype(auto) call_ParamClass_GetParamEntries(ATLImplementationDetails::low_priority_tag, Args&&... args) const
	{
		return ::ATL::_ParamClass::_GetParamEntries(ATLImplementationDetails::forward<Args>(args)...);
	}
};
ATLPREFAST_UNSUPPRESS()
...
struct Has_m_nAccessors : ATLImplementationDetails::false_type {};

template<class T>
struct Has_m_nAccessors<T, ATLImplementationDetails::void_t<m_nAccessors_unique_type,
	decltype(ATLImplementationDetails::declval<T>().m_nAccessors)>> : ATLImplementationDetails::true_type {};
...
private:
	...
	{
		return U::GetDefaultCommand(ATLImplementationDetails::forward<Args>(args)...);
	}

	template<class... Args>
	decltype(auto) call_CommandClass_GetDefaultCommand(ATLImplementationDetails::low_priority_tag, Args&&... args) const
	{
		return ::ATL::_CommandClass::GetDefaultCommand(ATLImplementationDetails::forward<Args>(args)...);
	}
};
ATLPREFAST_UNSUPPRESS()
