...
HRESULT Fire_OnFieldChange(
	...
	_In_ BOOL fCantDeny)
*/
struct Fire_OnFieldChange_unique_type; // TRANSITION, C1XX

template<class T, class = void>
struct Has_Fire_OnFieldChange : ATLImplementationDetails::false_type {};

template<class T>
struct Has_Fire_OnFieldChange<T, ATLImplementationDetails::void_t<Fire_OnFieldChange_unique_type,
	decltype(ATLImplementationDetails::declval<T>().Fire_OnFieldChange(
		ATLImplementationDetails::declval<IRowset*>(),
		HROW{},
		DBORDINAL{},
		ATLImplementationDetails::declval<DBORDINAL*>(),
		DBREASON{},
		DBEVENTPHASE{},
		BOOL{}))>> : ATLImplementationDetails::true_type {};
...
HRESULT Fire_OnRowChange(
	...
	_In_ BOOL fCantDeny)
*/
struct Fire_OnRowChange_unique_type; // TRANSITION, C1XX

template<class T, class = void>
struct Has_Fire_OnRowChange : ATLImplementationDetails::false_type {};

template<class T>
struct Has_Fire_OnRowChange<T, ATLImplementationDetails::void_t<Fire_OnRowChange_unique_type,
	decltype(ATLImplementationDetails::declval<T>().Fire_OnRowChange(
		ATLImplementationDetails::declval<IRowset*>(),
		DBCOUNTITEM{},
		ATLImplementationDetails::declval<HROW*>(),
		DBREASON{},
		DBEVENTPHASE{},
		BOOL{}))>> : ATLImplementationDetails::true_type {};
...
HRESULT Fire_OnRowsetChange(
	...
	_In_ BOOL fCantDeny)
*/
struct Fire_OnRowsetChange_unique_type; // TRANSITION, C1XX

template<class T, class = void>
struct Has_Fire_OnRowsetChange : ATLImplementationDetails::false_type {};

template<class T>
struct Has_Fire_OnRowsetChange<T, ATLImplementationDetails::void_t<Fire_OnRowsetChange_unique_type,
	decltype(ATLImplementationDetails::declval<T>().Fire_OnRowsetChange(
		ATLImplementationDetails::declval<IRowset*>(),
		DBREASON{},
		DBEVENTPHASE{},
		BOOL{})) >> : ATLImplementationDetails::true_type {};
