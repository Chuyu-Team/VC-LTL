...
public:
    ...
    _NODISCARD _Vector_const_iterator operator+(const difference_type _Off) const noexcept {
        _Vector_const_iterator _Tmp = *this;
        return _Tmp += _Off;
    }
    ...
    _NODISCARD difference_type operator-(const _Vector_const_iterator& _Right) const noexcept {
        _Compat(_Right);
...
public:
    ...
    _NODISCARD _Vector_iterator operator+(const difference_type _Off) const noexcept {
        _Vector_iterator _Tmp = *this;
        return _Tmp += _Off;
    }
...
public:
    ...
    _NODISCARD const_reference operator*() const noexcept {
#if _ITERATOR_DEBUG_LEVEL != 0
        const auto _Cont = static_cast<const _Mycont*>(this->_Getcont());
        _STL_VERIFY(_Cont, "cannot dereference value-initialized vector<bool> iterator");
        _STL_VERIFY(this->_Total_off(_Cont) < static_cast<_Difference_type>(_Cont->_Mysize),
    ...
    _NODISCARD _Vb_const_iterator operator+(const difference_type _Off) const noexcept {
        _Vb_const_iterator _Tmp = *this;
        return _Tmp += _Off;
    }
    ...
    _NODISCARD difference_type operator-(const _Vb_const_iterator& _Right) const noexcept {
        _Compat(_Right);
    ...
    _NODISCARD const_reference operator[](const difference_type _Off) const noexcept {
        return *(*this + _Off);
    }
...
public:
    ...
    _NODISCARD _Vb_iterator operator+(const difference_type _Off) const noexcept {
        _Vb_iterator _Tmp = *this;
        return _Tmp += _Off;
    }
