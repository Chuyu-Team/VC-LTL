// cp437 -- one- or two-byte/wide-character tables
...
namespace stdext {
    namespace cvt {
        ...
        template <class _Dummy>
        const unsigned short _tab_cp437<_Dummy>::_Btw[0x80] = { // map single bytes to words
        ...
        template <class _Dummy>
        const unsigned short _tab_cp437<_Dummy>::_Dbvalid[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp437<_Dummy>::_Dbtw[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp437<_Dummy>::_Wvalid[0x80] = { // words that map to single or double bytes
            0x00a0, 0x00a1, 0x00a2, 0x00a3, 0x00a5, 0x00aa, 0x00ab, 0x00ac, 0x00b0, 0x00b1, 0x00b2, 0x00b5, 0x00b7,
            0x00ba, 0x00bb, 0x00bc, 0x00bd, 0x00bf, 0x00c4, 0x00c5, 0x00c6, 0x00c7, 0x00c9, 0x00d1, 0x00d6, 0x00dc,
            0x00df, 0x00e0, 0x00e1, 0x00e2, 0x00e4, 0x00e5, 0x00e6, 0x00e7, 0x00e8, 0x00e9, 0x00ea, 0x00eb, 0x00ec,
            0x00ed, 0x00ee, 0x00ef, 0x00f1, 0x00f2, 0x00f3, 0x00f4, 0x00f6, 0x00f7, 0x00f9, 0x00fa, 0x00fb, 0x00fc,
        ...
        template <class _Dummy>
        const unsigned char _tab_cp437<_Dummy>::_Wtb[0x80] = { // map words to bytes
            0x00ff, 0x00ad, 0x009b, 0x009c, 0x009d, 0x00a6, 0x00ae, 0x00aa, 0x00f8, 0x00f1, 0x00fd, 0x00e6, 0x00fa,
            0x00a7, 0x00af, 0x00ac, 0x00ab, 0x00a8, 0x008e, 0x008f, 0x0092, 0x0080, 0x0090, 0x00a5, 0x0099, 0x009a,
            0x00e1, 0x0085, 0x00a0, 0x0083, 0x0084, 0x0086, 0x0091, 0x0087, 0x008a, 0x0082, 0x0088, 0x0089, 0x008d,
            0x00a1, 0x008c, 0x008b, 0x00a4, 0x0095, 0x00a2, 0x0093, 0x0094, 0x00f6, 0x0097, 0x00a3, 0x0096, 0x0081,
        ...
        class codecvt_cp437 : public _Cvt_one_byte<_Elem, _tab_cp437<int>, _Maxcode> {};
    } // namespace cvt
} // namespace stdext
