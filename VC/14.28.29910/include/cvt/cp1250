// cp1250 -- one- or two-byte/wide-character tables
...
namespace stdext {
    namespace cvt {
        ...
        template <class _Dummy>
        const unsigned short _tab_cp1250<_Dummy>::_Btw[0x80] = { // map single bytes to words
            0x20ac, 0x0000, 0x201a, 0x0000, 0x201e, 0x2026, 0x2020, 0x2021, 0x0000, 0x2030, 0x0160, 0x2039, 0x015a,
            0x0164, 0x017d, 0x0179, 0x0000, 0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014, 0x0000, 0x2122,
        ...
        template <class _Dummy>
        const unsigned short _tab_cp1250<_Dummy>::_Dbvalid[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp1250<_Dummy>::_Dbtw[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp1250<_Dummy>::_Wvalid[0x4a] = { // words that map to single or double bytes
            ...
            0x02c7, 0x02d8, 0x02d9, 0x02db, 0x02dd, 0x2013, 0x2014, 0x2018, 0x2019, 0x201a, 0x201c, 0x201d, 0x201e,
            0x2020, 0x2021, 0x2022, 0x2026, 0x2030, 0x2039, 0x203a, 0x20ac, 0x2122};

        template <class _Dummy>
        const unsigned char _tab_cp1250<_Dummy>::_Wtb[0x4a] = { // map words to bytes
            0x00c3, 0x00e3, 0x00a5, 0x00b9, 0x00c6, 0x00e6, 0x00c8, 0x00e8, 0x00cf, 0x00ef, 0x00d0, 0x00f0, 0x00ca,
            0x00ea, 0x00cc, 0x00ec, 0x00c5, 0x00e5, 0x00bc, 0x00be, 0x00a3, 0x00b3, 0x00d1, 0x00f1, 0x00d2, 0x00f2,
            0x00d5, 0x00f5, 0x00c0, 0x00e0, 0x00d8, 0x00f8, 0x008c, 0x009c, 0x00aa, 0x00ba, 0x008a, 0x009a, 0x00de,
            0x00fe, 0x008d, 0x009d, 0x00d9, 0x00f9, 0x00db, 0x00fb, 0x008f, 0x009f, 0x00af, 0x00bf, 0x008e, 0x009e,
            0x00a1, 0x00a2, 0x00ff, 0x00b2, 0x00bd, 0x0096, 0x0097, 0x0091, 0x0092, 0x0082, 0x0093, 0x0094, 0x0084,
            0x0086, 0x0087, 0x0095, 0x0085, 0x0089, 0x008b, 0x009b, 0x0080, 0x0099};
