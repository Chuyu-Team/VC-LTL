...
_NODISCARD inline unsigned long _Floor_of_log_2(const size_t _Value) noexcept
...
_NODISCARD inline unsigned long _Ceiling_of_log_2(const size_t _Value) noexcept
