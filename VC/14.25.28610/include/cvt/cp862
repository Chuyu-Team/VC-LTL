// cp862 -- one- or two-byte/wide-character tables
...
namespace stdext {
    namespace cvt {
        ...
        template <class _Dummy>
        const unsigned short _tab_cp862<_Dummy>::_Btw[0x80] = { // map single bytes to words
            ...
            0x05ea, 0x00a2, 0x00a3, 0x00a5, 0x20a7, 0x0192, 0x00e1, 0x00ed, 0x00f3, 0x00fa, 0x00f1, 0x00d1, 0x00aa,
        ...
        template <class _Dummy>
        const unsigned short _tab_cp862<_Dummy>::_Dbvalid[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp862<_Dummy>::_Dbtw[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp862<_Dummy>::_Wvalid[0x80] = { // words that map to single or double bytes
            0x00a0, 0x00a1, 0x00a2, 0x00a3, 0x00a5, 0x00aa, 0x00ab, 0x00ac, 0x00b0, 0x00b1, 0x00b2, 0x00b5, 0x00b7,
            0x00ba, 0x00bb, 0x00bc, 0x00bd, 0x00bf, 0x00d1, 0x00df, 0x00e1, 0x00ed, 0x00f1, 0x00f3, 0x00f7, 0x00fa,
            0x0192, 0x0393, 0x0398, 0x03a3, 0x03a6, 0x03a9, 0x03b1, 0x03b4, 0x03b5, 0x03c0, 0x03c3, 0x03c4, 0x03c6,
            0x05d0, 0x05d1, 0x05d2, 0x05d3, 0x05d4, 0x05d5, 0x05d6, 0x05d7, 0x05d8, 0x05d9, 0x05da, 0x05db, 0x05dc,
            0x05dd, 0x05de, 0x05df, 0x05e0, 0x05e1, 0x05e2, 0x05e3, 0x05e4, 0x05e5, 0x05e6, 0x05e7, 0x05e8, 0x05e9,
            0x05ea, 0x207f, 0x20a7, 0x2219, 0x221a, 0x221e, 0x2229, 0x2248, 0x2261, 0x2264, 0x2265, 0x2310, 0x2320,
        ...
        template <class _Dummy>
        const unsigned char _tab_cp862<_Dummy>::_Wtb[0x80] = { // map words to bytes
            0x00ff, 0x00ad, 0x009b, 0x009c, 0x009d, 0x00a6, 0x00ae, 0x00aa, 0x00f8, 0x00f1, 0x00fd, 0x00e6, 0x00fa,
            0x00a7, 0x00af, 0x00ac, 0x00ab, 0x00a8, 0x00a5, 0x00e1, 0x00a0, 0x00a1, 0x00a4, 0x00a2, 0x00f6, 0x00a3,
            0x009f, 0x00e2, 0x00e9, 0x00e4, 0x00e8, 0x00ea, 0x00e0, 0x00eb, 0x00ee, 0x00e3, 0x00e5, 0x00e7, 0x00ed,
            ...
            0x009a, 0x00fc, 0x009e, 0x00f9, 0x00fb, 0x00ec, 0x00ef, 0x00f7, 0x00f0, 0x00f3, 0x00f2, 0x00a9, 0x00f4,
        ...
        class codecvt_cp862 : public _Cvt_one_byte<_Elem, _tab_cp862<int>, _Maxcode> {};
    } // namespace cvt
} // namespace stdext
