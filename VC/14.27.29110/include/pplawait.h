...
namespace Concurrency {
    ...
    struct _Ppltask_awaiter {
        ...
        void await_suspend(_STD experimental::coroutine_handle<> _ResumeCb) {
            _Task.then(
...
#endif // defined(__cpp_coroutines) || defined(_RESUMABLE_FUNCTIONS_SUPPORTED)
...
#if defined(__cplusplus_winrt) && (defined(__cpp_coroutines) || defined(_RESUMABLE_FUNCTIONS_SUPPORTED)) \
...
#endif // defined(__cplusplus_winrt) && (defined(__cpp_coroutines) || defined(_RESUMABLE_FUNCTIONS_SUPPORTED))
...
namespace experimental {
    namespace details {
        namespace awaitabletraitsimpl {
            ...
            template <typename _Ty>
            inline true_type _TryAwaitable(
                _Ty, decltype(_TryAwaitReady(_STD declval<decay_t<_Ty>>(), 0, 0),
                         _TryAwaitSuspend(_STD declval<decay_t<_Ty>>(), _STD experimental::coroutine_handle<>(), 0, 0),
