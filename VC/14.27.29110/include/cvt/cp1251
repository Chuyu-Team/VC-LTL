// cp1251 -- one- or two-byte/wide-character tables
...
namespace stdext {
    namespace cvt {
        ...
        struct _tab_cp1251 {
            ...
            static const unsigned short _Wvalid[0x70];
            static const unsigned char _Wtb[0x70];
        };

        template <class _Dummy>
        const unsigned short _tab_cp1251<_Dummy>::_Btw[0x80] = { // map single bytes to words
        ...
        template <class _Dummy>
        const unsigned short _tab_cp1251<_Dummy>::_Dbvalid[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp1251<_Dummy>::_Dbtw[1] = {0};
        template <class _Dummy>
        const unsigned short _tab_cp1251<_Dummy>::_Wvalid[0x70] = { // words that map to single or double bytes
            0x0401, 0x0402, 0x0403, 0x0404, 0x0405, 0x0406, 0x0407, 0x0408, 0x0409, 0x040a, 0x040b, 0x040c, 0x040e,
            0x040f, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415, 0x0416, 0x0417, 0x0418, 0x0419, 0x041a, 0x041b,
            ...
            0x0451, 0x0452, 0x0453, 0x0454, 0x0455, 0x0456, 0x0457, 0x0458, 0x0459, 0x045a, 0x045b, 0x045c, 0x045e,
            0x045f, 0x0490, 0x0491, 0x2013, 0x2014, 0x2018, 0x2019, 0x201a, 0x201c, 0x201d, 0x201e, 0x2020, 0x2021,
            0x2022, 0x2026, 0x2030, 0x2039, 0x203a, 0x20ac, 0x2116, 0x2122};

        template <class _Dummy>
        const unsigned char _tab_cp1251<_Dummy>::_Wtb[0x70] = { // map words to bytes
            0x00a8, 0x0080, 0x0081, 0x00aa, 0x00bd, 0x00b2, 0x00af, 0x00a3, 0x008a, 0x008c, 0x008e, 0x008d, 0x00a1,
            0x008f, 0x00c0, 0x00c1, 0x00c2, 0x00c3, 0x00c4, 0x00c5, 0x00c6, 0x00c7, 0x00c8, 0x00c9, 0x00ca, 0x00cb,
            0x00cc, 0x00cd, 0x00ce, 0x00cf, 0x00d0, 0x00d1, 0x00d2, 0x00d3, 0x00d4, 0x00d5, 0x00d6, 0x00d7, 0x00d8,
            0x00d9, 0x00da, 0x00db, 0x00dc, 0x00dd, 0x00de, 0x00df, 0x00e0, 0x00e1, 0x00e2, 0x00e3, 0x00e4, 0x00e5,
            0x00e6, 0x00e7, 0x00e8, 0x00e9, 0x00ea, 0x00eb, 0x00ec, 0x00ed, 0x00ee, 0x00ef, 0x00f0, 0x00f1, 0x00f2,
            0x00f3, 0x00f4, 0x00f5, 0x00f6, 0x00f7, 0x00f8, 0x00f9, 0x00fa, 0x00fb, 0x00fc, 0x00fd, 0x00fe, 0x00ff,
            0x00b8, 0x0090, 0x0083, 0x00ba, 0x00be, 0x00b3, 0x00bf, 0x00bc, 0x009a, 0x009c, 0x009e, 0x009d, 0x00a2,
            0x009f, 0x00a5, 0x00b4, 0x0096, 0x0097, 0x0091, 0x0092, 0x0082, 0x0093, 0x0094, 0x0084, 0x0086, 0x0087,
            0x0095, 0x0085, 0x0089, 0x008b, 0x009b, 0x0088, 0x00b9, 0x0099};
