...
namespace details
{
    ...
    private:
        ...
        /// </summary>
        static void CALLBACK ExternalContextBase::ImplicitDetachHandler(PTP_CALLBACK_INSTANCE instance, PVOID parameter, PTP_WAIT waiter, TP_WAIT_RESULT waitResult);

        /// <summary>
        ///     Same callback function as ImplicitDetachHandler but used on XP.
        /// </summary>
        static void CALLBACK ExternalContextBase::ImplicitDetachHandlerXP(PVOID parameter, BOOLEAN is_timeout);
