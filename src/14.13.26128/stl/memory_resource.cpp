...
extern "C" _CRTIMP3 _Aligned_new_delete_resource_impl * __cdecl _Aligned_new_delete_resource() _NOEXCEPT
	{
	return (&_Immortalize<_Aligned_new_delete_resource_impl>());
	}

extern "C" _CRTIMP3 _Unaligned_new_delete_resource_impl * __cdecl _Unaligned_new_delete_resource() _NOEXCEPT
	{
...
extern "C" _CRTIMP3 memory_resource * __cdecl _Aligned_set_default_resource(memory_resource * const _Resource) _NOEXCEPT
	{
...
extern "C" _CRTIMP3 memory_resource * __cdecl _Unaligned_set_default_resource(memory_resource * const _Resource) _NOEXCEPT
	{
	memory_resource * const _Temp = __crt_interlocked_exchange_pointer(&_Default_resource, _Resource);
	if (_Temp)
		{
...
extern "C" _CRTIMP3 _NODISCARD memory_resource * __cdecl null_memory_resource() _NOEXCEPT
	{
