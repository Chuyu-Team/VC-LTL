...
_CONCRTIMP scheduler_resource_allocation_error::scheduler_resource_allocation_error(const char* message, HRESULT hresult) throw()
...
///     HRESULT of error that caused this exception
/// </param>
_CONCRTIMP scheduler_resource_allocation_error::scheduler_resource_allocation_error(HRESULT hresult) throw()
...
_CONCRTIMP HRESULT scheduler_resource_allocation_error::get_error_code() const throw()
{
    return _Hresult;
}
...
/**/
_Use_decl_annotations_
_CONCRTIMP scheduler_worker_creation_error::scheduler_worker_creation_error(const char * message, HRESULT hresult) throw()
...
/// </param>
/**/
_CONCRTIMP scheduler_worker_creation_error::scheduler_worker_creation_error(HRESULT hresult) throw()
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP unsupported_os::unsupported_os(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP unsupported_os::unsupported_os() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP scheduler_not_attached::scheduler_not_attached(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP scheduler_not_attached::scheduler_not_attached() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP improper_scheduler_attach::improper_scheduler_attach(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP improper_scheduler_attach::improper_scheduler_attach() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP improper_scheduler_detach::improper_scheduler_detach(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP improper_scheduler_detach::improper_scheduler_detach() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP improper_scheduler_reference::improper_scheduler_reference(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP improper_scheduler_reference::improper_scheduler_reference() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP default_scheduler_exists::default_scheduler_exists(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP default_scheduler_exists::default_scheduler_exists() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP context_unblock_unbalanced::context_unblock_unbalanced(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP context_unblock_unbalanced::context_unblock_unbalanced() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP context_self_unblock::context_self_unblock(const char* message) throw()
    : exception(message)
{ }
...
///     Construct a context_unblock_unbalanced exception
/// </summary>
_CONCRTIMP context_self_unblock::context_self_unblock() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP missing_wait::missing_wait(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP missing_wait::missing_wait() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP bad_target::bad_target(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP bad_target::bad_target() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP message_not_found::message_not_found(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP message_not_found::message_not_found() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP invalid_link_target::invalid_link_target(const char* message) throw()
    : exception(message)
{ }
...
///     Construct a message_not_found exception
/// </summary>
_CONCRTIMP invalid_link_target::invalid_link_target() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP invalid_scheduler_policy_key::invalid_scheduler_policy_key(const char* message) throw()
    : exception(message)
{
}
...
/// </summary>
_CONCRTIMP invalid_scheduler_policy_key::invalid_scheduler_policy_key() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP invalid_scheduler_policy_value::invalid_scheduler_policy_value(const char* message) throw()
    : exception(message)
{
}
...
/// </summary>
_CONCRTIMP invalid_scheduler_policy_value::invalid_scheduler_policy_value() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP invalid_scheduler_policy_thread_specification::invalid_scheduler_policy_thread_specification(const char* message) throw()
    : exception(message)
{
}
...
/// </summary>
_CONCRTIMP invalid_scheduler_policy_thread_specification::invalid_scheduler_policy_thread_specification() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP nested_scheduler_missing_detach::nested_scheduler_missing_detach(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP nested_scheduler_missing_detach::nested_scheduler_missing_detach() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP operation_timed_out::operation_timed_out(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP operation_timed_out::operation_timed_out() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP invalid_multiple_scheduling::invalid_multiple_scheduling(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP invalid_multiple_scheduling::invalid_multiple_scheduling() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP invalid_oversubscribe_operation::invalid_oversubscribe_operation(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP invalid_oversubscribe_operation::invalid_oversubscribe_operation() throw()
    : exception()
{
}
...
/// </param>
_Use_decl_annotations_
_CONCRTIMP improper_lock::improper_lock(const char* message) throw()
    : exception(message)
{ }
...
/// </summary>
_CONCRTIMP improper_lock::improper_lock() throw()
    : exception()
{
}
