...
{
    static void set_app_type() throw() { _set_app_type(_crt_console_app); }
};

struct __scrt_winmain_policy
{
    static void set_app_type() throw() { _set_app_type(_crt_gui_app); }
};

struct __scrt_enclavemain_policy
{
    static void set_app_type() throw() { }
};

struct __scrt_file_policy
{
    static void set_fmode() throw() { _set_fmode(_get_startup_file_mode()); }
    static void set_commode() throw() { *__p__commode() = _commode = _get_startup_commit_mode(); }
};

struct __scrt_nofile_policy
{
    static void set_fmode() throw() { }
    static void set_commode() throw() { }
};
