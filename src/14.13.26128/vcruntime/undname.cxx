...
static constexpr pcchar_t tokenTable[] =
{
#if !VERS_32BIT
	"__near",		// TOK_near
	"__near ",		// TOK_nearSp
...
static constexpr pcchar_t nameTable[] =
{
	" new",
	" delete",
	"=",
...
static constexpr pcchar_t ehTable[] =
{
	" Ptr to Member Data'",
	" Catchable Type'",
...
static constexpr pcchar_t rttiTable[] =
{
	" Type Descriptor'",
