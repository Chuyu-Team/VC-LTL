...
namespace details
{
    ...
    public:
            ...
            m_pLock(pLock)
        {
            ...
            m_pSlots = _concrt_new Mailbox<T>::Slot[s_initialSize];
        ...
        void Push(T* element)
        {
            ...
            if (t < m_head + m_mask)  // == t < m_head + size - 1
            {
                ...
                GrowAndPush(element, Mailbox<T>::Slot());
        }
    ...
    private:
        ...
        void GrowAndPush(T* element, typename Mailbox<T>::Slot affinitySlot)
        {
            ...
            Mailbox<T>::Slot *pNewSlots = _concrt_new Mailbox<T>::Slot[newLength];
            Mailbox<T>::Slot *pOldSlots = m_pSlots;
