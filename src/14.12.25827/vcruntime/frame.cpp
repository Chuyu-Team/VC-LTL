...
extern "C" EXCEPTION_DISPOSITION __cdecl RENAME_EH_EXTERN(__InternalCxxFrameHandler)(
    ...
    _HybridGenerateThunks(RENAME_EH_EXTERN(__InternalCxxFrameHandler), 1);
#endif
...
#if defined(_M_HYBRID_X86_ARM64) && !defined(_CHPE_X86_ARM64_EH_)
    _HybridGenerateThunks(FindHandler, 1);
#endif
...
#if defined(_M_HYBRID_X86_ARM64) && !defined(_CHPE_X86_ARM64_EH_)
    _HybridGenerateThunks(FindHandlerForForeignException, 1);
#endif
...
#if defined(_M_HYBRID_X86_ARM64) && !defined(_CHPE_X86_ARM64_EH_)
    _HybridGenerateThunks(CatchIt, 1);
#endif
