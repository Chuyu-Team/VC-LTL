...
static inline void _Reverse_tail(_BidIt _First, _BidIt _Last) noexcept {
...
static inline size_t _Byte_length(void* _First, void* _Last) noexcept {
    return static_cast<unsigned char*>(_Last) - static_cast<unsigned char*>(_First);
}

static inline void _Advance_bytes(void*& _Target, ptrdiff_t _Offset) noexcept {
...
void* __cdecl __std_swap_ranges_trivially_swappable(void* _First1, void* _Last1,
    void* _First2) noexcept { // TRANSITION, legacy version of __std_swap_ranges_trivially_swappable_noalias, preserved
                              // for bincompat
