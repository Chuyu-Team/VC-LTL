...
// TRANSITION: _BADOFF remains for ABI compatibility
...
_MRTIMP2_PURE_NPURE void __CLRCALL_PURE_OR_CDECL ios_base::_Ios_base_dtor(ios_base* _This) { // destroy the object
...
_MRTIMP2_PURE_NPURE void __CLRCALL_PURE_OR_CDECL ios_base::_Addstd(
    ios_base* _This) { // add standard stream to destructor list
