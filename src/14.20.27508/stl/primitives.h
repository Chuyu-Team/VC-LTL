...
#pragma warning(pop)
        ...
        inline bool are_win7_sync_apis_available() {
            ...
            DYNAMICGETCACHEDFUNCTION(
                KERNEL32, PFNTRYACQUIRESRWLOCKEXCLUSIVE, TryAcquireSRWLockExclusive, pfTryAcquireSRWLockExclusive);
        ...
        inline bool are_vista_sync_apis_available() {
            ...
            DYNAMICGETCACHEDFUNCTION(
                KERNEL32, PFNINITIALIZECONDITIONVARIABLE, InitializeConditionVariable, pfInitializeConditionVariable);
