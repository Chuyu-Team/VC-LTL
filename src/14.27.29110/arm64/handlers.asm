...
;
        ...
        NESTED_ENTRY A64NAME(_CallSettingFrame)
        ...
        NESTED_END A64NAME(_CallSettingFrame)

        // TODO-ARM64X: AMD64-only function.  This is a temporary stub to allow linking.
        NESTED_ENTRY A64NAME(_CallSettingFrameEncoded)
        // TODO-ARM64X: Hack around windows build system bug
#ifndef _M_ARM64EC
        ALTERNATE_ENTRY |#_CallSettingFrameEncoded|
#endif
        ret
        NESTED_END A64NAME(_CallSettingFrameEncoded)
        END
