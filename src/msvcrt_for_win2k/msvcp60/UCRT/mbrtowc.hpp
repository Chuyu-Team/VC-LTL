...
namespace __crt_mbstring_win2k
{
    static size_t __cdecl __mbrtowc_utf8(wchar_t* pwc, const char* s, size_t n, mbstate_t* ps);
    static size_t __cdecl __mbsrtowcs_utf8(wchar_t* dst, const char** src, size_t len, mbstate_t* ps);
...
_LCRT_DEFINE_IAT_SYMBOL(mbrlen);
...
_LCRT_DEFINE_IAT_SYMBOL(mbrtowc);
...
_LCRT_DEFINE_IAT_SYMBOL(mbsrtowcs);
...
#define __mbrtoc32_utf8 mbrtoc32
