...
_LCRT_DEFINE_IAT_SYMBOL(_aligned_free);
...
_LCRT_DEFINE_IAT_SYMBOL(_aligned_malloc);
...
_LCRT_DEFINE_IAT_SYMBOL(_aligned_offset_malloc);
...
_LCRT_DEFINE_IAT_SYMBOL(_aligned_offset_realloc);
...
_LCRT_DEFINE_IAT_SYMBOL(_aligned_realloc);
