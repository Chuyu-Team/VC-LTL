...
// ARM64X-TODO: Implement this properly
volatile PVOID _guard_dispatch_icall_nop = NULL;
#endif
...
// vftable laid out by CastGuard. The CastBuardVftablesB section (created by the compiler) is aligned
