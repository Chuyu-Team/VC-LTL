...
//                                            va_list          _ArgList
//    );
#define __stdio_common_vswprintf(_Options,_Buffer,_BufferCount,_Format,_Locale,_ArgList) (_Buffer==NULL? _vscwprintf_l(_Format,_Locale, _ArgList): _vswprintf_l(_Buffer,_BufferCount,_Format,_Locale,_ArgList))
...
//                                            va_list          _ArgList
//    );
#define __stdio_common_vswprintf_s(_Options,_Buffer,_BufferCount,_Format,_Locale,_ArgList) (_Buffer==NULL? _vscwprintf_l(_Format,_Locale, _ArgList): _vswprintf_s_l(_Buffer,_BufferCount,_Format,_Locale,_ArgList))
