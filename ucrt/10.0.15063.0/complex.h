...
extern _Dcomplex __cdecl cacos(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl cacosh(_In_ _Dcomplex _Z);
extern double    __cdecl carg(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl casin(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl casinh(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl catan(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl catanh(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl ccos(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl ccosh(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl cexp(_In_ _Dcomplex _Z);
extern double    __cdecl cimag(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl clog(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl clog10(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl conj(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl cpow(_In_ _Dcomplex _X, _In_ _Dcomplex _Y);
extern _Dcomplex __cdecl cproj(_In_ _Dcomplex _Z);
extern double    __cdecl creal(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl csin(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl csinh(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl csqrt(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl ctan(_In_ _Dcomplex _Z);
extern _Dcomplex __cdecl ctanh(_In_ _Dcomplex _Z);
extern double    __cdecl norm(_In_ _Dcomplex _Z);

extern float     __cdecl cabsf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl cacosf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl cacoshf(_In_ _Fcomplex _Z);
extern float     __cdecl cargf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl casinf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl casinhf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl catanf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl catanhf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl ccosf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl ccoshf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl cexpf(_In_ _Fcomplex _Z);
extern float     __cdecl cimagf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl clogf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl clog10f(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl conjf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl cpowf(_In_ _Fcomplex _X, _In_ _Fcomplex _Y);
extern _Fcomplex __cdecl cprojf(_In_ _Fcomplex _Z);
extern float     __cdecl crealf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl csinf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl csinhf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl csqrtf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl ctanf(_In_ _Fcomplex _Z);
extern _Fcomplex __cdecl ctanhf(_In_ _Fcomplex _Z);
extern float     __cdecl normf(_In_ _Fcomplex _Z);

__inline long double __cdecl cabsl(_In_ _Lcomplex _Z)
{
	static_assert(sizeof(_Dcomplex) == sizeof(_Lcomplex), "Error sizeof(_Dcomplex)!=sizeof(_Lcomplex)");
	return cabs(*(_Dcomplex*)&_Z);
}
extern _Lcomplex   __cdecl cacosl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl cacoshl(_In_ _Lcomplex _Z);
extern long double __cdecl cargl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl casinl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl casinhl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl catanl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl catanhl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl ccosl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl ccoshl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl cexpl(_In_ _Lcomplex _Z);
extern long double __cdecl cimagl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl clogl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl clog10l(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl conjl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl cpowl(_In_ _Lcomplex _X, _In_ _Lcomplex _Y);
extern _Lcomplex   __cdecl cprojl(_In_ _Lcomplex _Z);
extern long double __cdecl creall(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl csinl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl csinhl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl csqrtl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl ctanl(_In_ _Lcomplex _Z);
extern _Lcomplex   __cdecl ctanhl(_In_ _Lcomplex _Z);
extern long double __cdecl norml(_In_ _Lcomplex _Z);

extern _Dcomplex __cdecl _Cbuild(_In_ double _Re, _In_ double _Im);
extern _Dcomplex __cdecl _Cmulcc(_In_ _Dcomplex _X, _In_ _Dcomplex _Y);
extern _Dcomplex __cdecl _Cmulcr(_In_ _Dcomplex _X, _In_ double _Y);

extern _Fcomplex __cdecl _FCbuild(_In_ float _Re, _In_ float _Im);
extern _Fcomplex __cdecl _FCmulcc(_In_ _Fcomplex _X, _In_ _Fcomplex _Y);
extern _Fcomplex __cdecl _FCmulcr(_In_ _Fcomplex _X, _In_ float _Y);

extern _Lcomplex __cdecl _LCbuild(_In_ long double _Re, _In_ long double _Im);
extern _Lcomplex __cdecl _LCmulcc(_In_ _Lcomplex _X, _In_ _Lcomplex _Y);
extern _Lcomplex __cdecl _LCmulcr(_In_ _Lcomplex _X, _In_ long double _Y);
